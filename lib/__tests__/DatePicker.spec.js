...
describe('DatePicker', function () {
  ...
  it('maps onChange properly', function () {
    ...
    var dom = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(
      ...
      _react2.default.createElement(_DatePicker4.default, { name: 'myDatePicker', onChange: onChange, value: first })
    ));
  ...
  it('provides getRenderedComponent', function () {
    var dom = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(
      _MuiThemeProvider2.default,
      { muiTheme: (0, _getMuiTheme2.default)() },
      _react2.default.createElement(_DatePicker4.default, { name: 'myDatePicker', onChange: _lodash2.default })
    ));
