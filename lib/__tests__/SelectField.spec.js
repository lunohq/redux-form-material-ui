...
describe('SelectField', function () {
  ...
  it('renders a SelectField with an error', function () {
    (0, _expect2.default)(new _SelectField4.default({
      ...
      error: 'FooError',
      touched: true
    }).render()).toEqualJSX(_react2.default.createElement(_SelectField2.default, { name: 'mySelect', value: 'Foo', errorText: 'FooError', onChange: _lodash2.default, ref: 'component' }));
  });
  ...
  it('maps onChange properly', function () {
    ...
    var dom = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(
      ...
      _react2.default.createElement(_SelectField4.default, { name: 'mySelect', onChange: onChange, value: 'Foo' })
    ));
  ...
  it('provides getRenderedComponent', function () {
    var dom = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(
      _MuiThemeProvider2.default,
      { muiTheme: (0, _getMuiTheme2.default)() },
      _react2.default.createElement(_SelectField4.default, { name: 'mySelect' })
    ));
