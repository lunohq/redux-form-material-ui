...
describe('Slider', function () {
  ...
  it('renders a Slider with an error', function () {
    (0, _expect2.default)(new _Slider4.default({
      ...
      error: 'FooError',
      touched: true
    }).render()).toEqualJSX(_react2.default.createElement(_Slider2.default, { name: 'mySlider', value: 0.5, error: 'FooError', onChange: _lodash2.default, ref: 'component' }));
  });
  ...
  it('maps onChange properly', function () {
    ...
    var dom = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(
      ...
      _react2.default.createElement(_Slider4.default, { name: 'mySlider', onChange: onChange, value: 0.5 })
    ));
  ...
  it('provides getRenderedComponent', function () {
    var dom = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(
      _MuiThemeProvider2.default,
      { muiTheme: (0, _getMuiTheme2.default)() },
      _react2.default.createElement(_Slider4.default, { name: 'mySlider' })
    ));
